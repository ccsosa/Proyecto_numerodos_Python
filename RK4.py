# -*- coding: utf-8 -*-
"""
Created on Tue Nov 12 11:02:37 2019
...
def RK4(function,t0,y0,xmax,h):
    ...
    for i in range(1,intervals,1):
        ...
        k1 = h * dxdy(t,y,r)
        k2 = h * dxdy(((t+h)/2),((y+k1)/2),r)
        k3 = h * dxdy(((t+h)/2),((y+k2)/2),r)
        k4 = h * dxdy((t+h),(y+k3),r)
        t = t + h
...
r=0.1   
X = RK4(function=dxdy,t0=0,y0=1E6,xmax=20,h=0.25)
analitics = growth(t0=0,N0=1E6,xmax=20,h=0.25,r=r)
r=0.5
X2 = RK4(function=dxdy,t0=0,y0=1E6,xmax=20,h=0.25)
analitics2 = growth(t0=0,N0=1E6,xmax=20,h=0.25,r=r)
r=1
X3 = RK4(function=dxdy,t0=0,y0=1E6,xmax=20,h=0.25)
analitics3 = growth(t0=0,N0=1E6,xmax=20,h=0.25,r=r)
r=5
X4 = RK4(function=dxdy,t0=0,y0=1E6,xmax=20,h=0.25)
...
r=0.1   
ff_list1 = RK4(function=dxdy,t0=0,y0=1E6,xmax=20,h=0.25)
time_elapsed1 = (time.perf_counter() - time_start)

time_start = time.perf_counter()
r=0.5   
ff_list2 = RK4(function=dxdy,t0=0,y0=1E6,xmax=20,h=0.25)
time_elapsed2 = (time.perf_counter() - time_start)

time_start = time.perf_counter()
r=1  
ff_list3 = RK4(function=dxdy,t0=0,y0=1E6,xmax=20,h=0.25)
time_elapsed3 = (time.perf_counter() - time_start)

r=5   
ff_list4 = RK4(function=dxdy,t0=0,y0=1E6,xmax=20,h=0.25)
